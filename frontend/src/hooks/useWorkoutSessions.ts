...
export const workoutSessionKeys = {
    ...
    list: (traineeId: number) => [...workoutSessionKeys.lists(), traineeId] as const,
...
export const useWorkoutSessions = (traineeId: number, enabled = true) => {
    return useQuery({
        ...
        queryFn: () => workoutSessionService.getWorkoutSessionsForTrainee(traineeId),
...
export const useWorkoutSession = (
    ...
    return useQuery({
        ...
        queryFn: () =>
            workoutSessionService.getWorkoutSessionForTrainee(traineeId, sessionId),
